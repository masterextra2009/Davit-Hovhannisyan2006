...
export function AiPriceCard({ price }: { price: AiPriceBreakdown }) {
  return (
    ...
    >
      <div className="px-3.5 pt-3 pb-2 text-[11px] font-black uppercase tracking-widest text-indigo-300/80">
        Расчёт стоимости
      </div>
      ...
      <div className="flex items-center justify-between px-3.5 py-2.5 border-t border-white/10 bg-white/5">
        <span className="text-[12px] font-black text-white/80 uppercase tracking-wide">Итого</span>
