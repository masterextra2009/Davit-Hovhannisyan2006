 ...
 * ввода кода рядом остаётся — для кода, который Давид продиктовал лично. Общих
 * кодов (STUDENT15 и прочих) с 16.09.2026 нет: скидку даёт только личный код.
 * Свой код переписывать не нужно — это была самая частая причина, по которой
