...
export interface PrintFile {
  ...
  // Для формата А3 — клиент выбирает между "Чертёж" (тех. рисунок, обычно
  // Ч/Б) и "Фото" (полноцветная печать) в отдельной модалке, по образцу
  // Полароида, вместо общего переключателя Ч/Б/Цвет.
